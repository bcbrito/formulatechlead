      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div initial={{
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <Button onClick={handleCTA} size="lg" className="bg-blue-600 text-white font-semibold tracking-wide 
              hover:bg-blue-700 hover:shadow-xl active:scale-95 
              transition-all duration-300 text-lg px-10 py-6 rounded-lg flex items-center">
              Solicitar Diagnóstico Gratuito
              <ArrowRight className="ml-2 transition-transform group-hover:translate-x-1" size={12} />
            </Button>
        ...
        <motion.div initial={{
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img className="w-full h-[500px] object-cover" alt="Tech leadership strategic meeting" src="https://horizons-cdn.hostinger.com/b5bfb0c3-0fd4-4634-a3c4-7c1f4c4026c4/2469e6e5-ca08-4cf1-a295-340f0cd2c571-VtSOK.png" />
